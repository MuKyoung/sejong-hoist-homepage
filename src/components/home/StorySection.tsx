  ...
  en: [
    {
      ...
      sub: "We handle the entire lifecycle of ultra-heavy cranes: design, fabrication, installation, and safety certification.",
      caption: "350TON gantry crane · LS ELECTRIC Busan Plant",
    },
    {
      image: "/images/hero-04.jpg",
      title: ["Heavy loads, safely engineered", "from day one"],
      sub: "Safety factors and delivery risk are controlled by numbers from the design stage.",
      caption: "350/50TON grab crane · LS ELECTRIC Busan Plant",
    },
    {
      image: "/images/hero-03.jpg",
      title: ["Large grab cranes,", "designed and installed"],
      sub: "Outdoor heavy equipment engineered with wind-load and structural analysis.",
      caption: "250/50TON grab crane · LS ELECTRIC Busan Plant",
    },
    {
      image: "/images/pf-ceiling30.jpg",
      title: ["From overhead cranes", "to maintenance and A/S"],
      sub: "Scheduled inspections and rapid service keep your equipment running.",
      caption: "30TON overhead crane · LS ELECTRIC Busan Plant",
    },
  ],
};
