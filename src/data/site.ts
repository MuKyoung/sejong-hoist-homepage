...
export const HISTORY: { year: string; items: string[] }[] = [
  ...
  { year: "2024", items: ["(주)세종호이스트크레인으로 상호 변경 (2024.12)"] },
  { year: "2019", items: ["(주)SJ테크널 사업분야 분리·확장 (2019.05)"] },
  { year: "2015", items: ["세종호이스트로 상호 변경, 대표자 변경 (2015.08)"] },
  { year: "2006", items: ["금산군 추부면 공장 준공 (2006.06)"] },
  { year: "1999", items: ["정원기계 설립 (1999.08)"] },
];
...
export const CERT_DOCS: CertDoc[] = [
  ...
  {
    slug: "cert-3",
    title: "크레인 12대 일괄 안전인증",
    desc: "한국승강기안전공단 · KCs 개별 제품심사 적합",
    pageCount: 28,
  },
  {
    slug: "cert-4",
    title: "크레인 10대 일괄 안전인증",
    desc: "한국승강기안전공단 · KCs 개별 제품심사 적합",
    pageCount: 26,
  },
  {
    slug: "cert-5",
    title: "크레인 9대 일괄 안전인증",
    desc: "한국승강기안전공단 · KCs 개별 제품심사 적합",
    pageCount: 22,
  },
];
